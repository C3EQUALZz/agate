...
| `[policy.session_memory].ttl_secs` | целое (с) | Сколько карантин сессии живёт без активности. Сессия, простаивающая дольше, забывается. По умолчанию `3600`; должно быть > 0 при включении. Состояние — в пределах процесса; при нескольких репликах ставьте общий backend, если сессия может попасть на разные инстансы. |
